...
if __name__ == "__main__":
    df = pd.read_csv(f"{base_dir}/input/input-data.csv")
    ...
    joblib.dump(scaler, "model.joblib") # Persists the scaler object into a file
    with tarfile.open(f"{base_dir}/scaler_model/model.tar.gz", "w:gz") as tar_handle:
        tar_handle.add(f"model.joblib") # Add it to an archive file
